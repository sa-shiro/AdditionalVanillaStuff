...
public class ModItems {
    ...
    // DIRT SLABS
    public static final RegistryObject<Item> DIRT_SLAB = ITEM_REGISTRY.register("dirt_slab", () -> new BlockItem(ModBlocks.DIRT_SLAB.get(), SLABS_PROPERTIES));
    // TERRACOTTA SLABS
    ...
    // DIRT Wall
    public static final RegistryObject<Item> DIRT_WALL = ITEM_REGISTRY.register("dirt_wall", () -> new BlockItem(ModBlocks.DIRT_WALL.get(), WALLS_PROPERTIES));
    // TERRACOTTA WALLS
